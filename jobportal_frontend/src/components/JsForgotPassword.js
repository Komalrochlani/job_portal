...
export default function JsForgotPassword() {
  ...
  const handleSendOTP = async () => {
    try {
      const response = await axios.get(`http://localhost:7070/jobseeker/forgotpass/${userName}`);
  ...
  const handleVerifyOTP = async () => {
    try {
      const response = await axios.get(`http://localhost:7070/jobseeker/verify/${userName}/${otp}`);
  ...
  const handleResetPassword = async () => {
    try {
      const response = await axios.post(`http://localhost:7070/jobseeker/resetpass/${userName}`, {
